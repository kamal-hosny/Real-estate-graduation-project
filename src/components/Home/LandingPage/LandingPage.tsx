    ...
    <div className="landing-page relative">
      ...
      <div className="flex flex-col justify-center items-center gap-6 floating-content absolute top-1/2 -translate-x-1/2 left-1/2 -translate-y-1/2 z-[2]">
        <div 
          ...
          className="landing-page-info text-center flex flex-col justify-center items-center gap-4"
        >
          ...
          <p 
            ...
            className="description text-[#e5e7eb] w-10/12 max-md:w-96 leading-6 font-medium text-sm"
          >
