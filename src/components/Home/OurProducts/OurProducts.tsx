      ...
      <div className="container mx-auto px-4 space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="swiper-navigation flex gap-4">
            <button 
              className="swiper-prev border-2 border-color-border p-2 text-color-text-2 hover:text-color-text-1 rounded-full cursor-pointer"
            >
              <ArrowLeft size={28} />
            </button>
            <button 
              className="swiper-next border-2 border-color-border p-2 text-color-text-2 hover:text-color-text-1 rounded-full cursor-pointer"
            >
              <ArrowRight size={28} />
            </button>
          </div>
