  ...
  if (error) {
    return (
      <div className="w-screen h-screen flex justify-center items-center">
        <LottieHandler
          type="error"
          message={t("salesRequests.error", { 
            error: error || t("salesRequests.unknownError") 
          })}
        />
      </div>
    );
      ...
      <div className="flex flex-col justify-between gap-4 mb-6">
        ...
        <div className="flex gap-4 items-center justify-between">
          ...
          <span className="flex items-center gap-4">
            ...
            >
              <option value="newest">
                {t("salesRequests.sortOptions.newestFirst")}
              </option>
              <option value="oldest">
                {t("salesRequests.sortOptions.oldestFirst")}
              </option>
            </select>
